    ...
    <div className="flex flex-wrap gap-2 items-center">
      {chips.map((chip, i) => (
        <button
          ...
          className="flex items-center gap-2 text-xs font-body px-3 py-2 bg-elevated border border-accent/30 text-accent hover:bg-accent hover:text-base transition-colors min-h-[44px]"
        >
          {chip.label}
      ...
      <button
        ...
        className="text-xs font-body text-muted hover:text-secondary transition-colors min-h-[44px] px-2"
      >
        전체 초기화
      </button>
    </div>
